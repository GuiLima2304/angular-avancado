import { InMemoryObService, httpClientInMemBackendServiceFactory } from "angular-in-memory-web-api";

export class InMemoryDatabase implements InMemoryObService{
    createDb(){
        const categories = [
